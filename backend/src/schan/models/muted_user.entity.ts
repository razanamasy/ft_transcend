...
export class MutedUserEntity {
    ...
    @ManyToOne(() => SChanEntity, (schanEntity) => schanEntity.mutedList)
    public muteChan!: SChanEntity;

    @ManyToOne(() => UserEntity, (userEntity) => userEntity.mutedList)
    public muteUser!: UserEntity;
